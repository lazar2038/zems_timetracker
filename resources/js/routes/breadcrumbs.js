const breadcrumbs = {
    ...
    'projects.show' : [ {'route' : 'main', title: 'Главная'} , {'route' : 'projects.index', 'title' : "Проекты"}, {'title' : "Страница проекта", 'id' : true}],
    'projects.create' : [ {'route' : 'main', title: 'Главная'} , {'route' : 'projects.index', 'title' : "Проекты"}, {'title' : "Создание"}],
    'projects.edit' : [ {'route' : 'main', title: 'Главная'} , {'route' : 'projects.index', 'title' : "Проекты"}, {'route' : 'projects.show', 'title' : 'Страница проекта', 'id': true}, {'title' : "Редактирование проекта"}],
    'projects.delete' : [ {'route' : 'main', title: 'Главная'} , {'route' : 'projects.index', 'title' : "Проекты"}, {'route' : 'projects.show', 'title' : 'Страница проекта', 'id' : true}, {'title' : "Удаление проекта"}],
